		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					<li><a class="" href="adminDashboard.jsp"> <i
							class="icon_house_alt"></i> <span>Admin Dashboard</span>
					</a></li>
					<li class="active"><a class="#" href="listStndrd"> <i
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="icon_document_alt"></i>Standard
						</h3>
						<ol class="breadcrumb">
				...
				<div class="row">
					...
					<div class="container text-left">
						<button type="button" class="btn btn-success" data-toggle="modal"
							data-target="#exampleModal">Add Standard</button>
						&nbsp;&nbsp;
									...
									<div class="modal-body">
										...
										<form action="insertstandard" method="post" scope="request">
											...
											<div class="input-group">
												<span class="input-group-addon"><b>Standard Name:
												</b><i class="icon_document_alt"></i></span> <input type="text"
													class="form-control" id="standard_name"
													placeholder="standard name" name="standard_name" autofocus
													required>
											</div>
					...
					<div class="col-sm-9">
						<section class="panel">
							<header class="panel-heading"> List of Standards! </header>
							<table class="table">
								<thead>
									<tr>
										<th>Standard_id</th>
								...
								<tbody>
									...
									<c:forEach var="user" items="${listUser}">
										...
										<tr>
											<td><c:out value="${user.standard_id}" /></td>
											<td><c:out value="${user.standard_name}" /></td>

											<td><a
												href="deletestandard?standard_id=<c:out value='${user.standard_id}' />"
					...
					<div class="container text right">
						<img alt="img" src="img/standard.jpg"
							style="height: 280px; width: 780px" align="right"><br></br>
					</div>
				</div>
