...
<body>
	...
	<section id="container" class="">
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a class="#" href="listSub"> <i
							class="icon_book_alt"></i> <span>Subjects</span>
					</a></li>
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form action="<%=request.getContextPath()%>/insertsub"
											method="post">
											<div class="input-group">
												<span class="input-group-addon"><b>Subject Name:
												</b><i class="icon_document_alt"></i></span> <input type="text"
													class="form-control" id="sub_name"
													placeholder="subject name" name="sub_name" autofocus
													required>
											</div>
     ...
     Standard</a>&nbsp;-->
					...
					<div class="col-sm-9">
						<section class="panel">
							<header class="panel-heading"> List of Subjects </header>
							<table class="table">
								<thead>
									<tr>
										<th>Subject_id</th>
								...
								<tbody>
									...
									<c:forEach var="user" items="${listUser}">
										...
										<tr>
											<td><c:out value="${user.sub_id}" /></td>
											<td><c:out value="${user.sub_name}" /></td>

											<td><a
												href="delete?sub_id=<c:out value='${user.sub_id}' />"
					...
					<div class="container text right">
						<img alt="img" src="img/subjects.png"
							style="height: 250px; width: 650px" align="right"><br></br>
					</div>
