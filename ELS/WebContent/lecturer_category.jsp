...
<body>
	...
	<section id="container" class="">
		...
		<header class="header">
			...
			<!--logo start-->
			<a href="lecturerdashboard.html" class="logo"> <span class="lite">Welcome
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="lecturer_category.jsp" class="">
							<i class=" icon_folder"></i> <span>Category</span>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="icon_folder"></i>Category
						</h3>
						<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-sm-9">
						<section class="panel">
							<header class="panel-heading"> List of Categories! </header>
							<table class="table">
								<thead>
									<tr>
										<th>Category_id</th>
